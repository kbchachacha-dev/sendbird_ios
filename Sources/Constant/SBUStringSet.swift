...
public class SBUStringSet: NSObject {
    // MARK: - Common
    public static var Cancel = "취소"
    public static var OK = "확인"
    public static var Retry = "Retry"
    public static var Save = "저장"
    public static var Copy = "복사"
    public static var Delete = "삭제"
    public static var Edit = "수정"
    public static var Remove = "Remove"
    public static var Camera = "카메라"
    public static var PhotoVideoLibrary = "앨범"
    ...
    public static var Channel_Size_over_File = "30메가 이하의 이미지 파일만 전송 가능합니다."
